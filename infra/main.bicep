...
var apiIdentityName = !empty(apiUserAssignedIdentityName) ? apiUserAssignedIdentityName : '${abbrs.managedIdentityUserAssignedIdentities}api-${resourceToken}'
var apiIdentityResourceId = resourceId(subscription().subscriptionId, !empty(resourceGroupName) ? resourceGroupName : '${abbrs.resourcesResourceGroups}${environmentName}', 'Microsoft.ManagedIdentity/userAssignedIdentities', apiIdentityName)
...
module azureOpenAIRbac 'app/aoai-rbac.bicep' = {
  name: 'azureOpenAIRbac'
  scope: resourceGroup('rg-cloud-migration-copilot')
  params: {
    accountName: 'aoai-realtime-test01'
    managedIdentityPrincipalId: apiUserAssignedIdentity.outputs.principalId
    managedIdentityResourceId: apiIdentityResourceId
